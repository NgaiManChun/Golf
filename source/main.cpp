...
// マクロ定義
// =======================================================
#define CLASS_NAME "3kou"
#define WINDOW_CAPTION "3kou"
#define INIT_SCENE "game"
	...
	HINSTANCE hPrevInstance, LPSTR lpCmd, int nCmdShow)
{
	...
	{	//メッセージの有無をチェック
		...
		{
			MG::SetDeltaTime(min(dwCurrentTime - dwExecLastTime, 1000.0f / 24.0f));
